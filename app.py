...
def signup() -> str:
    if request.method == 'POST':  # If user submits signup form
        ...
        return render_template("signup.html", error="Username already exists")  # Error on username collision
...
def redirecting(furl: str) -> str:
    ...
    if res is not None:
        ...
        abort(404, description="Short URL not found")  # Return 404 if short URL is invalid
